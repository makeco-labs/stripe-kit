# [0.2.0](https://github.com/makeco-labs/stripe-kit/compare/v0.1.5...v0.2.0) (2026-01-04)


### Bug Fixes

* Isolate package for npm release to avoid workspace protocol ([fcc89a2](https://github.com/makeco-labs/stripe-kit/commit/fcc89a2e1a031d747f275feae9d215bad010cc91))
* Remove workspace lockfile before npm release ([6570d3f](https://github.com/makeco-labs/stripe-kit/commit/6570d3f7c4db1e7534d241e5b6b98b5638ae632e))


### Features

* Updated adapters to be same as stripe types. Refactored internally ([12d2de7](https://github.com/makeco-labs/stripe-kit/commit/12d2de77f81dd43a6004abffec5a7e0939280ce1))
* Updated adapters to be same as stripe types. Refactored internally ([ff7ac40](https://github.com/makeco-labs/stripe-kit/commit/ff7ac40f5c8fdf0a1ac4726418a4d3fdd60d4656))
